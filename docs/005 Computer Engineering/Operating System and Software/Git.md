---
alias: GIT VCS, Git SCM
tags: [Software-Development]
description: ""
share: true
---
---
> **Related Pages:** [Version Control System](./Version-Control-System.md)
---
# Introduction to Git

## Story of Git
[Linux](../../../Linux.md) Operating being Open Source maintains its kernel code accessible to the public. During the early years of maintenance (1991 - 2002), the changes to the kernel were passed around as patches and archived files.
...
### git help
Git has an extensive help system.
