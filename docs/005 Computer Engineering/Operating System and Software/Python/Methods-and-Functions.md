...
Methods and Functions form the basis of many programming languages as they allow the code to be concise and allows to reuse code to perform the same tasks.
