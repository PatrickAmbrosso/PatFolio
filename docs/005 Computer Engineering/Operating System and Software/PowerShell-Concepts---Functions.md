...
To change the function and what it does, it can be redefined once again and the changes are captured. Functions can be defined directly on the command line interface, in a script or in a [module](./PowerShell-Concepts---Modules.md). 
